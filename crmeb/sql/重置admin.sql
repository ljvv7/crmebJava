...
/*!40000 ALTER TABLE `eb_system_admin`
    DISABLE KEYS */;

INSERT INTO `eb_system_admin` (`id`, `account`, `pwd`, `real_name`, `roles`, `last_ip`, `update_time`, `create_time`,
                               `login_count`, `level`, `status`, `is_del`, `phone`, `is_sms`)
VALUES (1, 'admin', 'L8qdg72wbeQ=', 'admin', '1', '111.19.94.179', '2021-03-09 22:39:20', '2020-08-17 17:48:58', 1317,
        0, 1, 0, '18292417675', 0),
       (36, 'demo', 'Rb/KmlSjAxI=', '普通', '3', '60.210.126.252', '2021-02-04 11:23:03', '2021-02-04 11:23:03', 2, 1, 1,
        0, NULL, 0);
